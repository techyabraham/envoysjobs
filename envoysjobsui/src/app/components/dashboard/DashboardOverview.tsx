            ...
            <Card>
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-foreground-tertiary">Marketing Manager at Creative Agency • 2 hours ago</p>
                </div>
              </div>
            </Card>
            ...
            <Card>
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-foreground-tertiary">Regarding: Web Development Project • 5 hours ago</p>
                </div>
              </div>
            </Card>
            ...
            <Card>
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-foreground-tertiary">You're almost there! • 1 day ago</p>
                </div>
              </div>
            </Card>
          </div>
