...
const gigBaseSchema = zod_1.z.object({
...
const gigApplySchema = zod_1.z.object({
    counterBudget: zod_1.z.string().min(1).max(120).optional()
});
...
__decorate([
    ...
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)("id")),
    __param(2, (0, common_1.Body)(new zod_validation_pipe_1.ZodValidationPipe(gigApplySchema))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, void 0]),
    __metadata("design:returntype", void 0)
